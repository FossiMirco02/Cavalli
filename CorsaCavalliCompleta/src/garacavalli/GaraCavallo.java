...
public class GaraCavallo extends JFrame
{
    ...
    int totcavalli = 0;
    public GaraCavallo(int x) throws InterruptedException, IOException
    {
    ...
    public void visualizzaClassifica()
    {
        ...
        JLabel[] arrivi = new JLabel[totcavalli];
        ...
        classifica.getContentPane().setLayout(new GridLayout(totcavalli,1));
    ...
    public static void main(String[] args) throws InterruptedException, IOException 
    {
        ...
        Scanner input = new Scanner(System.in);*/
        PreparazioneGara prep = new PreparazioneGara();
        
        t.sleep(5000);
        ncavalli = prep.getCavalli();
